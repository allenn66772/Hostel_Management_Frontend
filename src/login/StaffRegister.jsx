...
import { registerStaffAPI } from '../../service/allAPI';
...
function StaffRegister() {
 const [staffreg,setstaffreg]=useState({
  ...
  const {fullname,email,password,confrimpassword}=staffreg.staffDetails
  ...
  try{
    const result=await registerStaffAPI(staffreg.staffDetails)
    console.log(result);
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="mb-4">
              ...
              <input
                ...
                value={staffreg.staffDetails.fullname}
                onChange={(e) =>
                  setstaffreg({
                    staffDetails: {
                      ...staffreg.staffDetails,
            ...
            <div className="mb-4">
              ...
              <input
                ...
                value={staffreg.staffDetails.email}
                onChange={(e) =>
                  setstaffreg({
                    staffDetails: {
                      ...staffreg.staffDetails,
            ...
            <div className="mb-4">
              ...
              <input
                ...
                value={staffreg.staffDetails.password}
                onChange={(e) =>
                  setstaffreg({
                    staffDetails: {
                      ...staffreg.staffDetails,
            ...
            <div className="mb-6">
              ...
              <input
                ...
                value={staffreg.staffDetails.confrimpassword}
                onChange={(e) =>
                  setstaffreg({
                    staffDetails: {
                      ...staffreg.staffDetails,
